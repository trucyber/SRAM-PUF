...
// Check the proper functionality of the SRAM
void verify_sram() {
    int wrong_count = 0;
    sram.turn_on();
...
void get_data_remanence(bool write_ones) {
...
int main(int argc, char **argv){
    ...
    // the get data_remanence function helps us to identify how many strong bits we get at different shutdown times
    printf("******Looking for strong zeros******\n");
    get_data_remanence(true);
    printf("\n******Looking for strong ones******\n");
    get_data_remanence(false);
